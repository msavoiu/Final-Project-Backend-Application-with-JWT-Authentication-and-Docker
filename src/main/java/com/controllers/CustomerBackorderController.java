...
import com.dto.CustomerBackorderDTO;
import com.services.CustomerBackorderService;
...
public class CustomerBackorderController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody CustomerBackorderDTO updatedCustomerBackorderDTO) {
